                ...
                <div id="header-carousel" className="carousel slide" data-bs-ride="carousel">
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img className="w-100" src="img/carousel-bg-1.jpg" height="500px" width="100%" alt="" />
                        ...
                        <div className="carousel-item">
                            <img className="w-100" src="img/carousel-bg-2.jpg" height="500px" width="100%" alt="" />
                            <div className="carousel-caption d-flex align-items-center">
                                <div className="container">
                                    <div className="row align-items-center justify-content-center justify-content-lg-start">
                                        <div className="col-10 col-lg-7 text-center text-lg-start">
                ...
                <div className="container">
                    <div className="row g-4">
                        ...
                        <div className="col-md-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <p className="text-white mb-0">Categories of product</p>
                        </div>
                        ...
                        <div className="col-md-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.7s">
                            ...
                            <h2 className="text-white mb-2" data-toggle="counter-up">9k+</h2>
                            <p className="text-white mb-0"> Customer Services</p>
                        </div>
                    </div>
                </div>
            </div>
