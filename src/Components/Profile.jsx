            ...
            <div className="container-fluid my-3">
                <div className="row">
                    <div className="col-md-6">
                        {
                            user.pic ?
                                <img src={`/products/${user.pic}`} height="385px" width="100%" alt="" /> :
                                <img src={`/img/No-img.png`} height="385px" width="100%" alt="" />
                                    ...
                                    </tr>
                                    {
                                        wishlist.map((item, index) => {
                                            return <tr key={index}>
                                                ...
                                                <td><button className='btn ' onClick={() => deleteItem(item.id)}><i className='fa fa-trash text-primary'></i></button></td>
                                            </tr>
                                        })
                                    }
                                </tbody>
